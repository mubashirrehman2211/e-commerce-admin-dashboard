...
<template>
  <div class="bg-gray-800 rounded-xl p-4 shadow-md relative">
    <h2 class="text-lg font-semibold text-red-600 dark:text-red-400 mb-3">Low Inventory</h2>
    <ul class="divide-y divide-gray-200 dark:divide-gray-700">
      <li v-for="product in lowInventory" :key="product.id" class="py-3 flex justify-between items-center">
    ...
    <RouterLink to="/products" class="absolute right-2 bottom-2 text-color">
